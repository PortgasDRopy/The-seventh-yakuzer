...
namespace The_seventh_yakuzer
{
    internal static class GameData
    {
        ...
        public static Character KiryuBrawl { get;} = new Character("Kazuma Kiryu (Brawler)", "", new List<GameData.Type> {Type.BLUNT}, 100, 50, 7, 7, 5, 3, 3, KiryuBrawlAttacks, LightAndMedium, null);
        public static Character KiryuRush { get;} = new Character("Kazuma Kiryu (Rush)", "", new List<GameData.Type> { Type.ELEC }, 100, 50, 3, 3, 5, 3, 10, KiryuRushAttacks, new List<WeaponType> () { Knuckles, BaghNakas}, null);
        public static Character KiryuBeast { get;} = new Character("Kazuma Kiryu (Beast)", "", new List<GameData.Type> { Type.FIRE }, 100, 50, 10, 10, 5, 5, 1, KiryuBeastAttacks, WeaponTypes, null);
        public static Character KiryuLegend { get;} = new Character("Kazuma Kiryu (Legend)", "", new List<GameData.Type> { Type.BLUNT, Type.FIRE }, 100, 50, 10, 7, 5, 5, 5, KiryuLegendAttacks, LightAndMedium, null);
        ...
        public static Character Nishiki { get;} = new Character("Akira Nishikiyama", "", new List<GameData.Type> { Type.ICE }, 70, 50, 7, 5, 5, 5, 5, NishikiAttacks, LightAndMedium, null);
        public static Character KuzeUnarmed { get;} = new Character("Daisaku Kuze (Unarmed)", "", new List<GameData.Type> { Type.FIRE }, 100, 50, 10, 8, 3, 4, 2, KuzeAttacks, new List<WeaponType>() { Knuckles, BaghNakas }, null);
        public static Character KuzePipe { get;} = new Character("Daisaku Kuze (Pipe)", "", new List<GameData.Type> { Type.BLUNT }, 100, 50, 10, 9, 6, 4, 1, KuzePipeAttacks, new List<WeaponType>() { PipesAndBatons }, SturdyIronPipe);
        public static Character Kuze { get; } = new Character("Daisaku Kuze", "", new List<Character>() { KuzeUnarmed, KuzePipe });
        public static Character Kashiwagi { get;} = new Character("Osamu Kashiwagi", "", new List<GameData.Type> { Type.MAGIC }, 60, 30, 10, 5, 3, 3, 3, KashiwagiAttacks, null, null);
        public static Character YonedaUnarmed { get;} = new Character("Yoneda (Unarmed)", "", new List<GameData.Type> { Type.BLUNT }, 40, 40, 3, 3, 3, 3, 2, YonedaAttacks, null, null);
        public static Character YonedaTanto { get; } = new Character("Yoneda (Tanto)", "", new List<GameData.Type> { Type.BLADE }, 40, 40, 5, 3, 4, 3, 2, YonedaTantoAttacks, new List<WeaponType>() { Daggers, Knives }, SturdyDagger);
        public static Character Yoneda { get; } = new Character("Yoneda", "", new List<Character>() { YonedaUnarmed, YonedaTanto });
        public static Character Tachibana { get;} = new Character("Tetsu Tachibana", "", new List<GameData.Type> { Type.ELEC }, 30, 100, 3, 3, 8, 7, 4, TachibanaAttacks,  null, null);
        public static Character OdaUnarmed { get;} = new Character("Jun Oda (Unarmed)", "", new List<GameData.Type> { Type.BLUNT }, 60, 40, 5, 5, 2, 3, 4, OdaAttacks, null, null);
        public static Character OdaTonfa { get; } = new Character("Jun Oda (Tonfa)", "", new List<GameData.Type> { Type.MAGIC }, 60, 40, 7, 6, 5, 5, 3, OdaTonfaAttacks, new List<WeaponType>() { Tonfas }, SturdyTonfa);
        public static Character Oda { get; } = new Character("Jun Oda", "", new List<Character>() { OdaUnarmed, OdaTonfa });
        public static Character MajimaThug { get;} = new Character("Goro Majima (Thug)", "", new List<GameData.Type> { Type.ELEC }, 60, 70, 4, 3, 6, 7, 4, MajimaThugAttacks, LightAndMedium, null);
        public static Character MajimaSlug { get; } = new Character("Goro Majima (Slugger)", "", new List<GameData.Type> { Type.BLUNT }, 60, 70, 7, 6, 2, 4, 3, MajimaSlugAttacks, Medium, SturdyBat);
        public static Character MajimaBreak { get; } = new Character("Goro Majima (Breaker)", "", new List<GameData.Type> { Type.FIRE }, 60, 70, 2, 1, 10, 4, 10, MajimaBreakAttacks, Light, null);
        public static Character MajimaLegend { get; } = new Character("Goro Majima (Legend)", "", new List<GameData.Type> { Type.BLADE, Type.ELEC }, 60, 70, 6, 2, 8, 4, 9, MajimaLegendAttacks, new List<WeaponType>() { Daggers}, SturdyDagger);
        ...
        public static Character Lee { get; } = new Character("Wen Hai Lee", "", new List<GameData.Type> { Type.GUN }, 100, 60, 7, 6, 6, 4, 5, LeeAttacks, new List<WeaponType>() { Knives }, SturdyKnife);
    }
}
