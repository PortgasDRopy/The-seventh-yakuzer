...
namespace The_seventh_yakuzer
{
    internal class Armor : Item
    {
        ...
        public Armor(string name, string sprite, int rarity, GameData.BodyPart bodyPart, List<string> effectList, int PV, int PM, int attack, int defense, int magic, int willpower, int agility, int power)
