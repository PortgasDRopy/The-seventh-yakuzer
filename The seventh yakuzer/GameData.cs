...
namespace The_seventh_yakuzer
{
    internal static class GameData
    {
        ...
        public static Character KiryuLegend { get;} = new Character("Kazuma Kiryu (Legend)", "", new List<GameData.Type> { Type.BLUNT, Type.FIRE }, 10, 5, 10, 7, 5, 5, 5, KiryuLegendAttacks, LightAndMedium, null);
