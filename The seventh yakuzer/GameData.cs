...
namespace The_seventh_yakuzer
{
    internal static class GameData
    {
        ...
        public static Character Nishiki { get;} = new Character("Akira Nishikiyama", "", new List<GameData.Type> { Type.ICE }, 7, 5, 7, 5, 5, 5, 5, NishikiAttacks, LightAndMedium, null);
        public static Character KuzeUnarmed { get;} = new Character("Daisaku Kuze (Unarmed)", "", new List<GameData.Type> { Type.FIRE }, 10, 5, 10, 8, 3, 4, 2, KuzeAttacks, new List<WeaponType>() { Knuckles, BaghNakas }, null);
        public static Character KuzePipe { get;} = new Character("Daisaku Kuze (Pipe)", "", new List<GameData.Type> { Type.BLUNT }, 10, 5, 10, 9, 6, 4, 1, KuzePipeAttacks, new List<WeaponType>() { PipesAndBatons }, SturdyIronPipe);
        public static Character Kuze { get; } = new Character("Daisaku Kuze", "", new List<Character>() { KuzeUnarmed, KuzePipe });
        public static Character Kashiwagi { get;} = new Character("Osamu Kashiwagi", "", new List<GameData.Type> { Type.MAGIC }, 6, 3, 10, 5, 3, 3, 3, KashiwagiAttacks, null, null);
        public static Character YonedaUnarmed { get;} = new Character("Yoneda (Unarmed)", "", new List<GameData.Type> { Type.BLUNT }, 4, 4, 3, 3, 3, 3, 2, YonedaAttacks, null, null);
        public static Character YonedaTanto { get; } = new Character("Yoneda (Tanto)", "", new List<GameData.Type> { Type.BLADE }, 4, 4, 5, 3, 4, 3, 2, YonedaTantoAttacks, new List<WeaponType>() { Daggers, Knives }, SturdyDagger);
        public static Character Yoneda { get; } = new Character("Yoneda", "", new List<Character>() { YonedaUnarmed, YonedaTanto });
        public static Character Tachibana { get;} = new Character("Tetsu Tachibana", "", new List<GameData.Type> { Type.ELEC }, 3, 10, 3, 3, 8, 7, 4, TachibanaAttacks,  null, null);
        public static Character OdaUnarmed { get;} = new Character("Jun Oda (Unarmed)", "", new List<GameData.Type> { Type.BLUNT }, 6, 4, 5, 5, 2, 3, 4, OdaAttacks, null, null);
        public static Character OdaTonfa { get; } = new Character("Jun Oda (Tonfa)", "", new List<GameData.Type> { Type.MAGIC }, 6, 4, 7, 6, 5, 5, 3, OdaTonfaAttacks, new List<WeaponType>() { Tonfas }, SturdyTonfa);
        public static Character Oda { get; } = new Character("Jun Oda", "", new List<Character>() { OdaUnarmed, OdaTonfa });
        public static Character MajimaThug { get;} = new Character("Goro Majima (Thug)", "", new List<GameData.Type> { Type.ELEC }, 6, 7, 4, 3, 6, 7, 4, MajimaThugAttacks, LightAndMedium, null);
        public static Character MajimaSlug { get; } = new Character("Goro Majima (Slugger)", "", new List<GameData.Type> { Type.BLUNT }, 6, 7, 7, 6, 2, 4, 3, MajimaSlugAttacks, Medium, SturdyBat);
        public static Character MajimaBreak { get; } = new Character("Goro Majima (Breaker)", "", new List<GameData.Type> { Type.FIRE }, 6, 7, 2, 1, 10, 4, 10, MajimaBreakAttacks, Light, null);
